...
def clicked5():
    print("input file encrypting  ")
    input_Encrypt()
    res_status = ("input encrypted ")
    lbl_status.configure(text= res_status)
    return 0
...
input_encrypt = Button(window, text="Encrypt input ", command=clicked5)

input_encrypt.grid( row=0,column=5)
